...
private constructor(
    ...
    val minFusionSamples: Int, // <-- new config parameter
    ...
    init {
        ...
        require(trainValidationRatio in 0.5..0.95) { "trainValidationRatio must be between 0.5 and 0.95" }
        require(enrollmentDataFilterRatio in 0.0..0.3) { "enrollmentDataFilterRatio must be between 0.0 and 0.3" }
        ...
        require(minFusionSamples > 0) { "minFusionSamples must be > 0" } // validation for new param
    }
    ...
    class Builder {
        ...
        private var minFusionSamples: Int = 20 // <-- default value
        ...
        fun minFusionSamples(value: Int) = apply { minFusionSamples = value } // setter for new param
        ...
        fun build(): AuthConfig =
            AuthConfig(
                ...
                minFusionSamples = minFusionSamples, // <-- included here
